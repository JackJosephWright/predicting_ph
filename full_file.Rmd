...
linear_model = lm(ph~.,ph_train%>%select(-c('brand_code',high_corr)))
lm_pred = predict(linear_model,ph_test)
RMSE(ph_test$ph,lm_pred)
...
pcr_pred = predict(pcr_model,apply_pca(pca_model,ph_test))
RMSE(ph_test$ph,pcr_pred)
...
Based on RMSE, nearest_neighbor model performed the best on the test data
